...
;; modified significantly by mkmcc, with no attempt to keep things
;; compatible.
...
(defun create-solarized-theme (variant)
  (let* ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(font-lock-comment-face ((,class (:foreground ,solarized-comments :slant italic))))
     ...
     ;; whitespace-mode
     `(whitespace-space ((,class (:background ,solarized-bg :foreground ,solarized-ws))))
     `(whitespace-hspace ((,class (:background ,solarized-bg :foreground ,solarized-ws))))
     `(whitespace-tab ((,class (:background ,solarized-bg :foreground ,red))))
     `(whitespace-newline ((,class (:foreground ,solarized-ws))))
     ...
     `(whitespace-indentation ((,class (:background ,solarized-bg :foreground ,solarized-ws))))
     `(whitespace-empty ((,class (:background ,yellow :foreground ,red))))
     `(whitespace-space-after-tab ((,class (:background ,solarized-bg :foreground ,solarized-ws))))
