...
;;;;; basic coloring
   ...
   `(link-visited
     ((t (:foreground ,zenburn-yellow-2 :underline t :weight normal))))
...
;;;;; compilation
   ...
   `(compilation-mode-line-exit
     ((t (:foreground ,zenburn-green+2 :weight bold))))
...
;;;;; grep
   ...
   `(match
     ((t (:background ,zenburn-bg-1 :foreground ,zenburn-orange :weight bold))))
;;;;; isearch
   `(isearch
     ((t (:foreground ,zenburn-yellow-2 :weight bold :background ,zenburn-bg-1))))
...
;;;;; full-ack
   ...
   `(ack-match
     ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1 :weight bold))))
;;;;; auctex
...
;;;;; auto-complete
   ...
   `(ac-selection-face
     ((t (:background ,zenburn-blue-4 :foreground ,zenburn-fg))))
   ...
   `(popup-isearch-match
     ((t (:background ,zenburn-bg :foreground ,zenburn-fg))))
;;;;; android mode
...
;;;;; bm
   ...
   `(bm-fringe-face
     ((t (:background ,zenburn-yellow-1 :foreground ,zenburn-bg))))
   `(bm-fringe-persistent-face
     ((t (:background ,zenburn-green-1 :foreground ,zenburn-bg))))
   `(bm-persistent-face
     ((t (:background ,zenburn-green-1 :foreground ,zenburn-bg))))
;;;;; clojure-test-mode
   ...
   `(clojure-test-error-face
     ((t (:foreground ,zenburn-red :weight bold :underline t))))
   `(clojure-test-success-face
     ((t (:foreground ,zenburn-green+1 :weight bold :underline t))))
;;;;; ctable
   `(ctbl:face-cell-select
     ((t (:background ,zenburn-blue :foreground ,zenburn-bg))))
   `(ctbl:face-continue-bar
     ((t (:background ,zenburn-bg-05 :foreground ,zenburn-bg))))
   `(ctbl:face-row-select
     ((t (:background ,zenburn-cyan :foreground ,zenburn-bg))))
;;;;; diff
...
;;;;; dired+
   ...
   `(diredp-dir-heading
     ((t (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
...
;;;;; ert
   `(ert-test-result-expected
     ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg))))
   `(ert-test-result-unexpected
     ((t (:foreground ,zenburn-red :background ,zenburn-bg))))
;;;;; eshell
...
;;;;; erc
   ...
   `(erc-prompt-face
     ((t (:foreground ,zenburn-orange :background ,zenburn-bg :weight bold))))
   `(erc-timestamp-face ((t (:foreground ,zenburn-green+1))))
   `(erc-underline-face ((t (:underline t))))
;;;;; git-gutter
   `(git-gutter:added
     ((t (:foreground ,zenburn-green :weight bold :inverse-video t))))
   `(git-gutter:deleted
     ((t (:foreground ,zenburn-red :weight bold :inverse-video t))))
   `(git-gutter:modified
     ((t (:foreground ,zenburn-magenta :weight bold :inverse-video t))))
...
;;;;; helm
   ...
   `(helm-visible-mark
     ((t (:foreground ,zenburn-bg :background ,zenburn-yellow-2))))
   `(helm-candidate-number
     ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg-1))))
...
;;;;; mic-paren
   `(paren-face-match
     ((t (:foreground ,zenburn-cyan :background ,zenburn-bg :weight bold))))
   `(paren-face-mismatch
     ((t (:foreground ,zenburn-bg :background ,zenburn-magenta :weight bold))))
   `(paren-face-no-match
     ((t (:foreground ,zenburn-bg :background ,zenburn-red :weight bold))))
;;;;; mingus
...
;;;;; org-mode
   ...
   `(org-warning
     ((t (:bold t :foreground ,zenburn-red :weight bold :underline nil))))
   `(org-column ((t (:background ,zenburn-bg-1))))
   `(org-column-title
     ((t (:background ,zenburn-bg-1 :underline t :weight bold))))
;;;;; outline
...
;;;;; show-paren
   `(show-paren-mismatch
     ((t (:foreground ,zenburn-red-3 :background ,zenburn-bg :weight bold))))
   `(show-paren-match
     ((t (:foreground ,zenburn-blue-1 :background ,zenburn-bg :weight bold))))
;;;;; sml-mode-line
...
;;;;; tabbar
   ...
   `(tabbar-selected
     ((t (:foreground ,zenburn-fg :background ,zenburn-bg
...
;;;;; term
   `(term-color-black
     ((t (:foreground ,zenburn-bg :background ,zenburn-bg-1))))
   `(term-color-red
     ((t (:foreground ,zenburn-red-2 :background ,zenburn-red-4))))
   `(term-color-green
     ((t (:foreground ,zenburn-green :background ,zenburn-green+2))))
   `(term-color-yellow
     ((t (:foreground ,zenburn-orange :background ,zenburn-yellow))))
   `(term-color-blue
     ((t (:foreground ,zenburn-blue-1 :background ,zenburn-blue-4))))
   `(term-color-magenta
     ((t (:foreground ,zenburn-magenta :background ,zenburn-red))))
   `(term-color-cyan
     ((t (:foreground ,zenburn-cyan :background ,zenburn-blue))))
   `(term-color-white
     ((t (:foreground ,zenburn-fg :background ,zenburn-fg-1))))
   '(term-default-fg-color ((t (:inherit term-color-white))))
   '(term-default-bg-color ((t (:inherit term-color-black))))
;;;;; modeline
   `(mode-line
     ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+3
               :box (:line-width 6 :color ,zenburn-bg+3 :style nil)))))
   `(mode-line-inactive
     ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+2
               :box (:line-width 6 :color ,zenburn-bg+2 :style nil)))))
   `(mode-line-read-only-face
     ((,class (:foreground ,zenburn-blue
               :box (:line-width 2 :color ,zenburn-blue :style nil)))))
   `(mode-line-blank-face
     ((,class (:inherit mode-line-face
               :box (:line-width 2 :color ,zenburn-bg+3 :style nil)))))
   `(mode-line-modified-face
     ((,class (:inherit font-lock-warning-face :underline nil
               :box (:line-width 2)))))
   `(mode-line-folder-face
     ((,class (:inherit mode-line-face :foreground ,zenburn-green))))
   `(mode-line-folder-face
     ((,class (:inherit mode-line-face :foreground ,zenburn-yellow :weight bold))))
   `(mode-line-position-face
     ((,class (:foreground ,zenburn-green+4))))
   `(mode-line-mode-face
     ((,class (:foreground ,zenburn-orange :weight bold))))
   `(mode-line-minor-mode-face
     ((,class (:foreground ,zenburn-orange :height 110))))
   `(mode-line-process-face
     ((,class (:inherit mode-line-face :foreground ,zenburn-green))))
   `(mode-line-80col-face
     ((,class (:foreground ,zenburn-bg-1 :background ,zenburn-yellow))))
   `(mode-line-buffer-id ((,class (:foreground ,zenburn-orange :weight bold))))
;;;;; volatile-highlights
   `(vhl/default-face ((t (:background ,zenburn-bg+2))))
;;;;; emacs-w3m
   ...
   `(w3m-header-line-location-title
     ((t (:foreground ,zenburn-yellow :underline t :weight bold))))
...
;;;;; whitespace-mode
   ...
   `(whitespace-space-before-tab
     ((t (:background ,zenburn-orange :foreground ,zenburn-orange))))
   `(whitespace-indentation
     ((t (:background ,zenburn-yellow :foreground ,zenburn-red))))
...
;;;;; wanderlust
   ...
   `(wl-highlight-summary-disposed-face
     ((t (:foreground ,zenburn-fg :slant italic))))
