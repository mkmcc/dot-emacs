...
(defvar mu4e-headers-new-mark       (purecopy '("N" . "N")) "New.")
...
(defvar mu4e-headers-encrypted-mark (purecopy '("x" . "x")) "Encrypted.")
(defvar mu4e-headers-signed-mark    (purecopy '("s" . "☡")) "Signed.")
(defvar mu4e-headers-unread-mark    (purecopy '("u" . "u")) "Unread.")
